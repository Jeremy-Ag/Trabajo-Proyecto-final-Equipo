...
new Vue({
    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                title: "Acerca de",
                html: `Creado por EcoMatch</a>
                <br>
                <strong>Créditos</strong>
                <br>
                Integrantes del Equipo:
                <div>Aguilar Morales Jeremy Joad
                <br>Portilla Alonso Edgar Javier
                <br>Torres Del Angel Karina Itzel
                <br>Villegas López Kassandra Isabel
                <br>Para Proyecto Final de Programación Web
                </div>
                `,
